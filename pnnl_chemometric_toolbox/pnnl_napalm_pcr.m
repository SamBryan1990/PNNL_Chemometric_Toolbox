function [C_pcr, RMSEP_pcr, C_pcr_train, RMSEC_pcr, C_pcr_cross_validation, RMSECV_pcr, data] = pnnl_napalm_pcr(nPrincipalComponents,varargin)
    ...
    %
    %   [C_pcr, RMSEP_pcr, C_pcr_train, RMSEC_pcr, C_pcr_cross_validation, RMSECV_pcr, data] = pnnl_napalm_pcr(r)
    ...
    %   Examples:
    %
    %      % Plot results of PCR on napalm data for 2, 4, and 8 principal components
    %      r = [2 4 8];
    %      pnnl_napalm_pcr(r)
    %
    %      % Return results of PCR on napalm data for 2, 4, and 8 principal components without plotting
    %      r = [2 4 8];
    %      [C_pcr, RMSEP_pcr, C_pcr_train, RMSEC_pcr, C_pcr_cross_validation, RMSECV_pcr, data] = pnnl_napalm_pcr(r)
